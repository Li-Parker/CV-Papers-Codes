...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.last_layer = nn.Sequential(
            ...
            self.norm_layer(num_classes, eps=1e-3)
        )
...
if __name__ == '__main__':
    ...
    img = img.to(device)
    print(img.size()[1])
    model = HighResolutionNet(cfg=hrnet32, original_figure_channel=img.size()[1], options=None, num_classes=12)
